...
<body>
    ...
    if (isset($_POST['like_button'])) {
        ...
        $total_user_likes++;
        $user_likes = mysqli_query($conn, "UPDATE users SET num_likes='$total_likes' WHERE username='$user_liked'");
        $insertUser = mysqli_query($conn, "INSERT INTO likes VALUES(NULL, '$userLoggedIn', '$post_id')");
    ...
    if (isset($_POST['unlike_button'])) {
        ...
        $total_user_likes--;
        $user_likes = mysqli_query($conn, "UPDATE users SET num_likes='$total_likes' WHERE username='$user_liked'");
        $insertUser = mysqli_query($conn, "DELETE FROM likes WHERE username = '$userLoggedIn' AND post_id = '$post_id'");
