...
<body>
    ...
    <form action=" <?php echo $_SERVER['PHP_SELF'] . '?post_id=' . $post_id; ?>" method="POST" id="comment_form" name="postComment<?php echo $post_id; ?>">
        <textarea name="post_body"></textarea>
        <input type="submit" value="Submit" name="postComment<?php echo $post_id; ?>">
    </form>
    ...
    if ($count != 0) {
        while ($comment = mysqli_fetch_array($get_comments)) {
            ...
            <div class="comment_section">
                <a href="<?php echo $posted_by; ?>" target="_parent"><img src="<?php echo $user_obj->getProfilePic(); ?>" alt="<?php echo $user_obj->getFirstAndLastName(); ?>" title="<?php echo $posted_by; ?>" style='float:left;' height='30'></a>
